...
class CommonQueries{
	 ...
	 */
	public function __construct($username='budgetawayadb', $password='Budget@123', $db='budgetawayadb', $host = "budgetawayadb.db.12171148.hostedresource.com", $suppress=false) {
//	public function __construct($username='holidaypackage', $password='Holiday@123', $db='holidaypackage', $host = "holidaypackage.db.12171148.hostedresource.com", $suppress=false) {
//	public function __construct($username='root', $password='', $db='packages', $host = "localhost", $suppress=false) {
...
/**
 * Select all records from perticular table
 * Enter description here ...
 * @param unknown_type $from
 */
public function select_all_records($from) {
